...
<head>
    ...
    <title>@yield('title', 'Upload - SorriDoc')</title>
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0 flex items-center">
                        ...
                        <span class="ml-2 text-sm text-teal-200">| Upload de Documentos</span>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <span class="text-sm">{{ $company->corporate_name }}</span>
                    <form method="POST" action="{{ route('upload.logout', $token) }}">
                        @csrf
